...
local osc_styles = {
    ...
    wcButtons = "{\\blur1\\bord0.5\\1c&HFFFFFF&\\3c&H0\\fs24\\fnmodernx-osc-icon}",
...
local window_control_box_width = 128
...
function window_controls()
    ...
    local first_geo =
        {x = controlbox_left - 4, y = button_y, an = 4, w = 24, h = 24}
    local second_geo =
        {x = controlbox_left + 40, y = button_y, an = 4, w = 24, h = 24}
    local third_geo =
        {x = controlbox_left + 80, y = button_y, an = 4, w = 24, h = 24}
